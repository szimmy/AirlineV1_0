...
public class Driver {
	...
	private static void createAirplanes()  {
		...
		planes.add(new SixSeatPlane(1, "S601", new Route( 90.0, "Chicago", "New York City",
				LocalDateTime.of(2015, 12, 04, 9, 00, 00), LocalDateTime.of(2015, 12, 04, 15, 00, 00))));
		...
		planes.add(new TwelveSeatPlane(1, "S1201", new Route( 50.0, "Chicago",
				"Philadelphia",	LocalDateTime.of(2015, 12, 17, 8, 00, 00), LocalDateTime.of(2015, 12, 17, 14, 00, 00))));
