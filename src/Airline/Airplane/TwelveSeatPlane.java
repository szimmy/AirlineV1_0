...
public class TwelveSeatPlane extends Airplane {
	...
	private static final String ID_FILE_NAME = "FIles\\Airplanes\\current_highest_id_twelve.txt";

	private final String FILE_NAME = "Files\\Airplanes\\airplanetwelve" + getId() + ".ser";
	 ...
	 */
	public static TwelveSeatPlane deserialize(int id) {
		try(FileInputStream fs = new FileInputStream("Files\\Airplanes\\airplanetwelve" + id + ".ser");
				ObjectInputStream os = new ObjectInputStream(fs)) {
			return (TwelveSeatPlane) os.readObject();
		}
		catch (IOException e) {
			e.printStackTrace();
		}
